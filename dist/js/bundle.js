...
var hamburger = function hamburger() {
  ...
  menuBacking.addEventListener('click', function (e) {
...
var modals = function modals() {
  ...
  function openModal() {
    var window = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : modal;
    var classActive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'modal_active';
    // modal.classList.add('modal_active');
    window.classList.add("".concat(classActive));
    document.body.style.overflowY = 'hidden';
  }
  function closeModal() {
    var window = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : modal;
    var classActive = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'modal_active';
    window.classList.remove("".concat(classActive));
    document.body.style.overflowY = '';
  }
};
...
var slider = function slider() {
  ...
  function slider() {
    ...
    var offset = 0;
    var slideIndex = 1;
    sliderInner.style.height = "".concat(100 * slides.length, "%");
    ...
    arrowDown.addEventListener('click', function (e) {
      ...
      sliderInner.style.transform = "translateY(-".concat(offset, "px)");
      setActiveDot();
    });
...
var tabs = function tabs(trigger, triggerParent, content) {
  if (document.body.classList.contains('with-tabs')) {
    ...
    hideTabContent();
    showTabContent();
    triggersParent.addEventListener('click', function (e) {
      var target = e.target;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.produce__btn', '.produce__btns', '.produce__items');
